...
def create_sql_json_files(path_abs, sql_folder, json_folder, tables_folder, path_file_dic, col_name, type_name, comment_col, date_cols, table, schema):
    ...
    for sheet in sheets:
        ...
        create_sql(path_sql, sql_file, df, schema, table_name, col_name, type_name, comment_col, date_cols)
