...
from config import path_file_config, api_config, url_config, sql_config, credentials_config
...
#                           folder_resources = path_file_config.folder_resources,
#                           file_data_name = path_file_config.file_name,
#                           file_name = path_file_config.file_exports,
#                           url = url_config.url,
#                           days = None,
#                           token = api_config.api_key,
#                           path_exports = path_file_config.path_exports,
